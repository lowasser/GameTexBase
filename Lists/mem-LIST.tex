...
\NEW{MemFold}{\mTest}{
  ...
  \s\MYtrigger	{Open if you drink any fluid}
  \s\MYtext	{Good on you for staying hydrated.}
}
...
\NEW{MemEnvelope}{\mAmazing}{
	\s\MYname{Mempacket C}
  \s\MYtrigger	{if you see something amazing}
...
\NEW{MemPage}{\mPageOne}{
  \s\MYtrigger	{Open if you speak to \cTest{\full}.}
  \s\MYtext	{This is page 1}
}

\NEW{MemPage}{\mPageTwo}{
  \s\MYtrigger	{Open if trigger 2}
  \s\MYtext	{This is page 2}
}
