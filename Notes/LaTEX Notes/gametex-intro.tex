...
There is one case \gametex{} is specifically, \emph{unusually} bad for: games that want significant elements of graphic design or visual branding.  You can add images, with some work you could likely automatically add images to all of some type of element like characters sheets, and you can control fonts and the like, but it would be very difficult to build a game with printed content that did not look a lot like this document's aesthetic.
\end{subsection}
\end{section}
