...
a handy feature for players out of character \emph{or} characters who are in game but undetectable.
...
The first thing to do will be to examine the core file where most of \gametex{} is written: \lstinline|LaTeX/gametex.sty|.  This defines \gametex{}'s default behavior, though in some places it also defines tools to configure that behavior.  A common example is the definition of ``maps,'' like \lstinline|\badgemap| and \lstinline|\contactmap|.  These commands can be used to rearrange or reselect which elements of characters go into which location on the badges, or what is displayed when a character is listed as a contact on another character sheet.
...
To make a distinct aesthetic for your game, you will likely need to research the corresponding concepts in \LaTeX{}, and then hack \lstinline|gametex.sty| to apply the appropriate instructions in your game.  
\end{subsection}
\end{section}
\end{document}
